...
def build_embedding_network():
    ...
    input_ps_inde_04_cat = Input(shape=(1,))
    embedding = Embedding(3,2,input_length= 1)(input_ps_inde_04_cat)
    embedding = Reshape(target_shape=(2,))(embedding)
    inputs.append(input_ps_inde_04_cat)
    embeddings.append(embedding)
